...
<header class="header">
    <div class="container">
        ...
        <nav class="nav">
            <a href="/" on:click={() => animateScroll.scrollTo({element: '#charging'})} class="nav__link is-active">
                Charging
            </a>
            <a href="/" on:click={() => animateScroll.scrollTo({element: '#mobility'})} class="nav__link">
                Mobility
            </a>
            <a href="/" on:click={() => animateScroll.scrollTo({element: '#energy'})} class="nav__link">
                Energy
            </a>
            <a href="/" on:click={() => animateScroll.scrollTo({element: '#contact'})} class="nav__link is-contact">
                Contact
            </a>
