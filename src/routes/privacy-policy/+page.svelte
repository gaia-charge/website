...
<svelte:head>
  <title
    >{$isLoading
      ? ""
      : $_("privacy-policy.head", { default: "Privacy Policy" })} - Gaia Charge</title
  >
</svelte:head>
      ...
      <div class="container">
        ...
        <div>
          <div style="padding: 2em;">
            <p>
              At Gaia Charge, accessible from https://gaiacharge.com/, one
              of our main priorities is the privacy of our visitors. This
              Privacy Policy document contains types of information that is
              collected and recorded by Gaia Charge and how we use it.
            </p>
            ...
            <p>
              Gaia Charge follows a standard procedure of using log files.
            ...
            <p>
              ...
              the advertising partners of Gaia Charge.
            </p>

            <p>
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on Gaia Green
              Tech, which are sent directly to users' browser. They
            ...
            <p>
              Note that Gaia Charge has no access to or control over these
            ...
            <p>
              Gaia Charge's Privacy Policy does not apply to other
            ...
            <p>
              Gaia Charge does not knowingly collect any Personal
            ...
            <p>
              ...
              information that they shared and/or collect in Gaia Charge.
