...
<ul class="flex flex-row items-center justify-around">
    <li><img src="{startup_valencia}" alt="Startup Valencia" /></li>
    <li><img src="{aedive}" alt="Asociación Empresarial para el Desarrollo e Impulso de la Movilidad Eléctrica" /></li>
    <li><img src="{avve}" alt="Asociación Valenciana del Vehículo Eléctrico" /></li>
    <li><img src="{adestic}" alt="Clúster de Empresas Innovadoras para el Turismo de la Comunitat Valenciana" /></li>
    <li><img src="{portal_sostenibilidad}" alt="Portal de Sostenibilidad de Cámara Valencia" /></li>
</ul>
