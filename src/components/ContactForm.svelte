<script>
  ...
  async function sendSubmitt() {
    ...
    if (!message) {
      errorMessage = true;
      err = $_("contact.errorMessage", {
        default: "Please enter the message",
      });
      return false;
    }
...
<form action="" class="form">
  ...
  <div class="form__group">
    <input
      ...
      bind:value={name}
      placeholder={$_("contact.phName", { default: "Your name" })}
    />
  </div>
  <div class="form__group">
    <input
      ...
      bind:value={email}
      placeholder={$_("contact.phEmail", { default: "user@domain.com" })}
    />
  </div>
  <div class="form__group">
    <textarea
      class="form__control is-textarea"
      class:error={errorMessage}
      bind:value={message}
      placeholder={$_("contact.phMessage", {
  ...
  <button
    type="submit"
    on:click|preventDefault={sendSubmitt}
    class="form__submit"
    >{$_("contact.button", { default: "Send message" })}</button
  >
